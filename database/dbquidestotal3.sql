...
--
-- Servidor: localhost
-- Tiempo de generación: 25-12-2017 a las 21:36:13
...
(1, 8, '2017-11-27', '2017-12-28', 6, 1),
(2, 9, '2017-11-25', '2018-01-18', 7, 1),
(12, 12, '2017-12-01', '2017-12-05', 9, 1);
...
(1, 'consulta unidd de cuidados', 'uni', '#161efb', 100),
(2, 'consultas verdes', 'V', '#00ff00', 207),
(3, 'consultas amarillas', 'A', '#fffa0f', 300);
...
(1, 'Fernandez García, Aurelio José', '968112233', 'me1@quides.es', 'personal/guapo.jpg', 1),
(2, 'Médico dos', '968112233', 'me2@quides.es', 'personal/NoFoto.gif', 1),
(3, 'Médico tres', '968112233', 'me3@quides.es', 'personal/NoFoto.gif', 0),
(4, 'Médico cuatro', '968112233', 'me4@quides.es', 'personal/NoFoto.gif', 1),
(5, 'Médico cinco', '968112233', 'me1@quides.es', 'personal/foto.jpg', 1),
(6, 'Médico seis', '968112233', 'me2@quides.es', 'personal/NoFoto.gif', 1),
(7, 'Médico siete', '968112233', 'me1@quides.es', 'personal/ciclista.jpg', 0),
(8, 'Médico ocho', '968112233', 'me2@quides.es', 'personal/NoFoto.gif', 1),
(9, 'Médico NUEVE', '968112233', 'me2@quides.es', 'personal/NoFoto.gif', 1),
(10, 'Médico DIEZ de rebenga', '968112233 968514594 619230465', 'mediezderebenga@quides.es', 'personal/NoFoto.gif', 1),
(12, 'Lopez Garcia, Pedro antonio', '4454545', 'lopez@ddd.es', 'personal/IMG_5931.JPG', 1);
...
(1, 'Mañana', '08:00:00.0000', '15:00:00.0000', 'M1', 1),
(2, 'Tarde', '15:00:00.0000', '22:00:00.0000', 'T', 1),
(3, 'Guardia', '08:00:00.0000', '07:59:00.0000', 'Gro', 1),
(4, 'Descanso Guardia', '08:00:00.0000', '07:59:00.0000', 'D1', 1);
...
(1, 'Francisco Andrés', 'dismun@dismun.com', '$2y$10$vjoKWYE4N7PogeXu51JDM.xDK98vWRu7SokKkhyGDkw1oL2NL9OcW', 1, 'R5sfthkftpTCes8PLzUdeMqXjbMbssRDzcM4S0adAwt2gG49asb0p1ZpavzG', '2017-12-17 16:40:36', '2017-12-17 16:40:36'),
...
--
ALTER TABLE `chamanes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de registro', AUTO_INCREMENT=13;
...
--
ALTER TABLE `turnos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de regidtro', AUTO_INCREMENT=7;
