...
--
-- Servidor: localhost
-- Tiempo de generación: 21-12-2017 a las 18:09:35
...
--
-- RELACIONES PARA LA TABLA `bosquejo`:
--   `idpersona`
--       `personas` -> `id`
--   `idpunto`
--       `puntos` -> `id`
...
--
-- RELACIONES PARA LA TABLA `calendario_laboral`:
--
...
--
-- RELACIONES PARA LA TABLA `categorias_externos`:
--
...
--
-- RELACIONES PARA LA TABLA `chamanes`:
--   `idpersona`
--       `personas` -> `id`
--   `idpunto`
--       `puntos` -> `id`
...
--
-- RELACIONES PARA LA TABLA `clave`:
--   `idturno`
--       `turnos` -> `id`
--
...
--
-- RELACIONES PARA LA TABLA `equipos_composicion`:
--   `idequipo`
--       `equipos` -> `id`
--   `idpersona`
--       `personas` -> `id`
...
--
-- RELACIONES PARA LA TABLA `persona_externos`:
--   `idcategoria`
--       `categorias_externos` -> `id`
--   `idpersona`
--       `personas` -> `id`
--
...
--
-- RELACIONES PARA LA TABLA `puntos`:
--   `idcentro`
--       `centros` -> `id`
--   `idnivel`
--       `niveles` -> `id`
...
--
-- RELACIONES PARA LA TABLA `sabadosydomingos`:
--   `idcentro`
--       `centros` -> `id`
--
...
--
-- RELACIONES PARA LA TABLA `tipos_incidencias`:
--
...
(1, 'Francisco Andrés', 'dismun@dismun.com', '$2y$10$vjoKWYE4N7PogeXu51JDM.xDK98vWRu7SokKkhyGDkw1oL2NL9OcW', 1, 'txAOGFXDkHvZmmhq4X8CKuR78pcyhCGGttWubE98WNMlG3G3SIcmKLvVqEmC', '2017-12-17 16:40:36', '2017-12-17 16:40:36'),
...
--
ALTER TABLE `centros`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador de Reginstro', AUTO_INCREMENT=22;
