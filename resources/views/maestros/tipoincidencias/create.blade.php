	...
	<div class="col-sm-8">
    	...
    	<blockquote class="blockquote">
			<form method="POST">
				...
				<div class="row">
					<input class="btn btn-danger" type="submit" value="Añadir Tipo de Incidencia" />
			    	<a href="{{ url('/tipoincidencias') }}"> <input class="btn btn-success" type="button" value="Cancelar" style="display:inline"/></a>
				</div>
			</form>
		</blockquote>
	</div>
